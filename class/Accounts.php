    ...
    class Accounts extends DBAbstractModel {
        ...
        public function getUserAccounts($idUser, $search = '') {
            if ($search == '' || $search == '*') {
                ...
                FROM jano_accounts A, jano_keys K, jano_platform_categories C, jano_platforms_list P
        ...
        public function getAccountById($idUser, $idAccount) {
            $this->query = "SELECT P.name,A.id,A.idCategory,A.idPlatform,
                            ...
                            FROM jano_accounts A, jano_keys K, jano_platforms_list P 
                            WHERE K.idUser = A.idUser
                            AND K.idCategory = A.idCategory
                            AND A.id = :idAccount
                            AND A.idUser = :idUser
        ...
        public function getPassAccountById($idUser, $idAccount) {
            ...
            FROM jano_accounts A, jano_keys K 
            WHERE K.idUser = A.idUser
            AND K.idCategory = A.idCategory
            AND A.id = :idAccount
            AND A.idUser = :idUser";
        ...
        public function addAccount($data = array()) {
            $this->query = "INSERT INTO jano_accounts 
            (idUser,idCategory,idPlatform,name_account,pass_account,pass_date,url,info,notes)
            VALUES
            (:idUser,
            :idCategory,
            :idPlatform,
            HEX(AES_ENCRYPT(:name_account,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            HEX(AES_ENCRYPT(:pass_account,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            :pass_date,
            HEX(AES_ENCRYPT(:url,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            HEX(AES_ENCRYPT(:info,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            HEX(AES_ENCRYPT(:notes,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))) )";
        ...
        public function updateAccount($data = array()) {
            $this->query = "UPDATE jano_accounts 
            SET 
            idPlatform = :idPlatform,
            name_account = HEX(AES_ENCRYPT(:name_account,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            pass_account = HEX(AES_ENCRYPT(:pass_account,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            url = HEX(AES_ENCRYPT(:url,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            info = HEX(AES_ENCRYPT(:info,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory))),
            notes = HEX(AES_ENCRYPT(:notes,(SELECT password FROM jano_keys WHERE idUser = :idUser AND idCategory = :idCategory)))
            WHERE id = :idAccount";
        ...
        public function deleteAccount($idUser,$idAccount) {
            $this->query = "DELETE FROM jano_accounts WHERE id = :id AND idUser = :idUser";
        ...
        public function getIdCategoryByAccount($idAccount) {
            $this->query = "SELECT idCategory FROM jano_accounts WHERE id = :id";
