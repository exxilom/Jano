<?php
    ...
    class Platforms extends DBAbstractModel {
        ...
        public function getTotalPlatformCategories() {
            $this->query = "SELECT id FROM jano_platform_categories";
        ...
        public function getPlatformCategories() {
            $this->query = "SELECT * FROM jano_platform_categories WHERE id > 0";
        ...
        public function getCategoryIdByName($name) {
            $this->query = "SELECT id FROM jano_platform_categories WHERE category = :category";
        ...
        public function getPlatformsByCategory($id) {
            $this->query = "SELECT C.category, S.subcategory, P.name, P.id 
                            FROM jano_platform_categories C, jano_platform_subcategories S, jano_platforms_list P
        ...
        public function getPlatformsListByCategory($id) {
            $this->query = "SELECT P.id,P.name 
                            FROM jano_platform_categories C, jano_platforms_list P
                            WHERE C.id = P.idCategory
                            AND C.id = :id
                            ORDER BY P.name";
        ...
        public function getSubcategoriesList($id) {
            $this->query = "SELECT id, idCategory, subcategory FROM jano_platform_subcategories WHERE idCategory = :id";
        ...
        public function validateSubcategory($idCategory, $idSubcategory) {
            $this->query = "SELECT * FROM jano_platform_subcategories WHERE idCategory = :idCategory AND id = :idSubcategory";
        ...
        public function setPlatform( $platform_data = array() ) {
            $this->query = "INSERT INTO jano_platforms_list (idCategory,idSubcategory,name) 
        ...
        public function updatePlatform( $platform_data = array() ) {
            $this->query = "UPDATE jano_platforms_list 
        ...
        public function deletePlatform( $id ) {
            $this->query = "DELETE FROM jano_platforms_list WHERE id = :id";
